...
class OrquestraDinamicsProcessingClientsQueue extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Integration:OrquestraDinamicsProcessingClientsQueue';
     ...
     * @var string
     */
    protected $description = 'Rotina para processar os clientes do Orquestra na fila de integração com o dynamics';
    ...
    */
    ...
    protected $title           = 'Orquestra - Processamento dos Clientes Para o Dynamics';
