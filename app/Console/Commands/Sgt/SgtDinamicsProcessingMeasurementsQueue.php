...
class SgtDinamicsProcessingMeasurementsQueue extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Integration:SgtDinamicsProcessingMeasurementsQueue';
     ...
     * @var string
     */
    protected $description = 'Rotina para processar as medições do Sgt na fila de integração com o dynamics';
    ...
    */
    ...
    protected $title           = 'SGT - Processamento das Medições Para o Dynamics';
    ...
    {        
        ...
        foreach ($data as $key => $value) {
            ...
            try {
                ...
                $data = [
                    "CND_NUMMED" => (string) $properties['CND_NUMMED'],
                ...
                foreach ($properties['DADOSMEDICAO'] as $key => $valueCne) {
                    ...
                    $data['DADOSMEDICAO'][] = [
                        ...
                        "CNE_PRODUT" => (string) $valueCne->CNE_PRODUT
                    ];
                }                
