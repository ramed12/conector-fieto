	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
		        <div class="card mb-4">       
		            <div class="card-body">		                
				        {!! Form::model(Request::input(), ['method' => 'get', 'autocomplete' => 'on', 'route' => ['cms-schedules', http_build_query(Request::input())], 'class' => 'my-2']) !!}      		    
							<div class="row">
					        ...
					        <tbody>
					        	@foreach ($schedules as $value)
					        		<tr>
						                ...
						                <td  class="align-middle" data-label="Rotina">{!!$value->title!!}</td>
						                <td  class="align-middle" data-label="Status">{!!$value->status()!!}</td>     
						                <td  class="align-middle" data-label="Ações">
						                	<a href="{!!route('cms-schedules-show', [$value->id, http_build_query(Request::input())])!!}" class='btn  btn-primary ml-1'>Detalhes</a>
						                </td>  
						            </tr>
					        	@endforeach
					        </tbody>
